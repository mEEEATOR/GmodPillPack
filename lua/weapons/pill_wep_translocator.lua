...
function SWEP:PrimaryAttack()
	if CLIENT or !IsValid(self:GetTarget()) then return end
...
function SWEP:SecondaryAttack()
	...
	if !tr.Entity or tr.Entity:IsWorld() or !hook.Call("PhysgunPickup",GAMEMODE,self.Owner,tr.Entity) then
...
function SWEP:DrawHUD()
	...
	halo.Render{Ents={self:GetTarget()},Color=Color(0,255,255),BlurX=10,BlurY=10,DrawPasses=2,IgnoreZ=true}
end
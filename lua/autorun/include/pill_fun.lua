...
pk_pills.register("birdbrainswagtrain",{
	...
	attack2={
		mode= "trigger",
		func=function(ply,ent)
			if !ent.lastcar then ent.lastcar=ent end
			if !IsValid(ent.lastcar) then return end
...
pk_pills.register("haxman",{
	...
	boneMorphs = {
		["ValveBiped.Bip01_Head1"]={scale=Vector(3,3,3)}
	},
	sounds={
...
pk_pills.register("skeeter",{
	...
	boneMorphs = {
		["ValveBiped.Bip01_Head1"]={pos=Vector(5,0,0)},
		["ValveBiped.Bip01_L_Thigh"]={pos=Vector(10,0,0)},
		["ValveBiped.Bip01_R_Thigh"]={pos=Vector(-10,0,0)}
	},
	moveSpeed={
		walk=30,
		run=90

...
pk_pills.register("hula",{
	...
	hull=Vector(5,5,6),
	anims={default={idle="idle",shake="shake"}},
	attack={
		mode="auto",
		delay=.2,
...
pk_pills.register("sawblade",{
	...
	collide=function(ply,ent,collide)
		if collide.HitNormal.z < 0.5 && collide.HitNormal.z > -0.5 then
...
pk_pills.register("dorf",{
	...
	boneMorphs = {
		["ValveBiped.Bip01_Pelvis"]={scale=Vector(2,2,2)},
		["ValveBiped.Bip01_Spine"]={scale=Vector(2,2,2)},
		["ValveBiped.Bip01_Spine1"]={scale=Vector(2,2,2)},
		["ValveBiped.Bip01_Spine2"]={scale=Vector(2,2,2)},
		["ValveBiped.Bip01_Spine4"]={scale=Vector(2,2,2)},
		["ValveBiped.Bip01_Head1"]={scale=Vector(4,4,4)},
		["ValveBiped.Bip01_L_Clavicle"]={pos=Vector(0,0,10)},
		["ValveBiped.Bip01_R_Clavicle"]={pos=Vector(0,0,-10)},
	},
	moveSpeed={
		walk=60,
		run=150

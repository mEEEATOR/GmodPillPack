...
pk_pills.register("ccamera",{
	...
	attack={
		...
		func=function(ply,ent)
			if ent.active and !ent.busy then
				ent:PillSound("pic")
			end
		end
	},
...
pk_pills.register("ccrawler",{
	...
	boneMorphs = {
		["Ground_turret.mesh2"]={rot=Angle(0,180,0)},
		["Ground_turret.Gun"]={rot=Angle(0,0,0),pos=Vector(0,-3,39)}
	},
	aim={
		attachment="eyes",
		simple=true
	...
	land=function(ply,ent)
		if IsValid(ent.trail) then ent.trail:Remove() end
	end,
	sounds={
